...
public:
    ...
    explicit TensorModel(const std::string& model_filename, const std::vector<uint8_t>& config_options = {});
    
    // Static members
    static TensorModel* TFInstance;
    static TensorModel* Instance(const std::string& model_filename, const std::vector<uint8_t>& config_options = {});
    ...
    TensorModel(const TensorModel&model) = delete;
    TensorModel(TensorModel&&model) = default;
    TensorModel& operator=(const TensorModel&model) = delete;
    TensorModel& operator=(TensorModel&&model) = default;
